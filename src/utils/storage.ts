    ...
    const updated = parsed.map((b) => {
      if (
        ...
        return {
          ...
          participants: (b.participants && b.participants.length > 0) ? b.participants : (defaultB1?.participants || []),
        };
      }
      if (
        ...
        return {
          ...
          participants: (b.participants && b.participants.length > 0) ? b.participants : (defaultB2?.participants || []),
        };
      }
      return b;
    });
