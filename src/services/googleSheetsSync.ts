...
export function processIndependenciaTab(
  ...
  let readingB1 = false;
  let readingB2 = false;
  let maxB1QuotaFound = 50;
  let maxB2QuotaFound = 40;
  ...
  const quotaPriceB1 = isMegaVirada ? 57.12 : 60.0;
  const quotaPriceB2 = isMegaVirada ? 35.70 : 39.0;
  ...
  if (bolao1Participants.length === 0) {
    const existingB1 = existingBoloes.find(
      (b) => b.id === 'bolao-1-mega-virada-57' || b.id === 'bolao-1-independencia-60' || b.title.includes('Bolão 1')
    );
  ...
  if (bolao2Participants.length === 0) {
    const existingB2 = existingBoloes.find(
      (b) => b.id === 'bolao-2-mega-virada-35' || b.id === 'bolao-2-independencia-39' || b.title.includes('Bolão 2')
    );
  ...
  const finalB1Quotas = Math.min(50, Math.max(50, maxB1QuotaFound, bolao1Participants.length));
  const finalB2Quotas = Math.min(40, Math.max(40, maxB2QuotaFound, bolao2Participants.length));
  ...
  const bolao1: Bolao = isMegaVirada
    ? {
        ...
        totalBolao: isMegaVirada ? 2856.0 : finalB1Quotas * quotaPriceB1,
        dezenas: 11,
        quotaPrice: 57.12,
        adminFeePercent: 0,
        adminFeeFixed: 0,
        ...
        pixKeyRecipient: 'allyson.leandro@gmail.com',
        pixKeyType: 'email',
        notes: `Bolão 1 Especial da Mega da Virada - 1 Bilhão 🥳🇧🇷 • 1 Aposta de 11 dezenas (R$ 2.772,00) + R$ 84,00 de reserva • ${finalB1Quotas} cotas de R$ 57,12 cada (Total: R$ 2.856,00).`,
        status: 'arrecadando',
        tickets: [
          {
            id: 'virada1-t-1',
  ...
  const bolao2: Bolao = isMegaVirada
    ? {
        ...
        totalBolao: isMegaVirada ? 1428.0 : finalB2Quotas * quotaPriceB2,
        dezenas: 10,
        quotaPrice: 35.70,
        adminFeePercent: 0,
        adminFeeFixed: 0,
        ...
        pixKeyRecipient: 'allyson.leandro@gmail.com',
        pixKeyType: 'email',
        notes: `Bolão 2 Especial da Mega da Virada - 1 Bilhão 🥳🇧🇷 • 1 Aposta de 10 dezenas (R$ 1.260,00) + R$ 168,00 de reserva • ${finalB2Quotas} cotas de R$ 35,70 cada (Total: R$ 1.428,00).`,
        status: 'arrecadando',
        tickets: [
          {
            id: 'virada2-t-1',
