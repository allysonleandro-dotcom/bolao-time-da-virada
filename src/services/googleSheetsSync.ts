...
export function processIndependenciaTab(
  ...
  const finalB1Quotas = Math.max(50, maxB1QuotaFound, bolao1Participants.length);
  const finalB2Quotas = Math.max(40, maxB2QuotaFound, bolao2Participants.length);
  ...
  const bolao1: Bolao = isMegaVirada
    ? {
        ...
        pixKeyRecipient: 'allyson.leandro@gmail.com',
        pixKeyType: 'email',
        notes: `Bolão 1 Especial da Mega da Virada - 1 Bilhão 🥳🇧🇷 • 2 Apostas de 11 dezenas • ${finalB1Quotas} cotas de R$ 57,12 cada (Total: R$ 2.856,00).`,
        status: 'arrecadando',
        tickets: [
          {
            id: 'virada1-t-1',
  ...
  const bolao2: Bolao = isMegaVirada
    ? {
        ...
        pixKeyRecipient: 'allyson.leandro@gmail.com',
        pixKeyType: 'email',
        notes: `Bolão 2 Especial da Mega da Virada - 1 Bilhão 🥳🇧🇷 • 1 Aposta de 13 dezenas • ${finalB2Quotas} cotas de R$ 35,70 cada (Total: R$ 1.428,00).`,
        status: 'arrecadando',
        tickets: [
          {
            id: 'virada2-t-1',
