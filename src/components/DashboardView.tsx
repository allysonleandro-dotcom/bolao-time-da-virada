                ...
                >
                  <div>
                    ...
                    <div className="p-6">
                      ...
                      <h4 className="font-black text-slate-900 text-lg mt-3 line-clamp-1 group-hover:text-emerald-600 transition tracking-tight">
                        {bolao.title}
                      </h4>
        ...
        >
          <div>
            ...
            <p className="text-slate-500 text-xs mt-1.5 leading-relaxed font-medium">
              Simule custos de apostas múltiplas na Mega-Sena, Lotofácil e Quina com cálculo exato de cotas e taxa do organizador.
            </p>
          </div>
