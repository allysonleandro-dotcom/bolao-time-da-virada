...
import { calculateBolaoFinancials, formatCurrency, formatDateBR, formatBolaoBetSummary, resolveLotteryType } from '../utils/calculator';
  ...
  return (
    <div className="space-y-6 pb-12">
        ...
        <div className="lg:col-span-7 bg-slate-900 rounded-3xl p-7 sm:p-8 text-white relative overflow-hidden shadow-xl border border-slate-800 flex flex-col justify-between min-h-[260px]">
          ...
          <div className="relative z-10 pt-6 flex flex-wrap items-center gap-3">
            <button
              ...
              className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black text-xs sm:text-sm px-5 py-3 rounded-xl shadow-lg shadow-emerald-950/40 transition active:scale-95 flex items-center gap-2 cursor-pointer"
            >
            ...
            <button
              id="dashboard-gerador-hero"
              onClick={() => onNavigate('gerador')}
              className="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white text-xs sm:text-sm font-bold px-4 py-3 rounded-xl border border-white/15 transition flex items-center gap-2 cursor-pointer"
            >
              <Dices className="w-4 h-4 text-amber-400" />
              <span>Gerador de Dezenas & PDF</span>
            </button>
        ...
        {activeBoloes.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {activeBoloes.map((bolao) => {
              const lotteryKey = resolveLotteryType(bolao.lotteryType, bolao.title);
              const config = LOTTERY_CONFIGS[lotteryKey] || LOTTERY_CONFIGS['mega-sena'];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div
          onClick={() => onNavigate('gerador')}
          className="bg-white border border-slate-200 rounded-3xl p-6 cursor-pointer hover:shadow-md hover:border-amber-300 transition group flex flex-col justify-between shadow-xs"
        >
          <div>
            ...
            <h4 className="font-black text-slate-900 text-base group-hover:text-amber-700 transition">
              Gerador de Dezenas & PDF
            </h4>
            <p className="text-slate-500 text-xs mt-1.5 leading-relaxed font-medium">
              Gere palpites estatísticos e aleatórios para Mega-Sena, Lotofácil, Quina e imprima cartões em PDF prontos para lotérica.
            </p>
          </div>
          <div className="mt-4 text-xs font-bold text-amber-700 flex items-center gap-1">
            <span>Gerar palpites</span>
            <ArrowRight className="w-3.5 h-3.5" />
          </div>
        </div>
        ...
        >
          <div>
            ...
            <h4 className="font-black text-slate-900 text-base group-hover:text-purple-700 transition">
              Calculadora & Fechamentos
            </h4>
            <p className="text-slate-500 text-xs mt-1.5 leading-relaxed font-medium">
              Simule custos de apostas múltiplas com cálculo de cotas, desdobramentos e arredondamentos.
            </p>
          </div>
        ...
        >
          <div>
            ...
            <p className="text-slate-500 text-xs mt-1.5 leading-relaxed font-medium">
              Importe listas de amigos, controle pagamentos de cotas e envie comprovantes via WhatsApp.
            </p>
          </div>
        ...
        >
          <div>
            ...
            <p className="text-slate-500 text-xs mt-1.5 leading-relaxed font-medium">
              Configure concurso, cotas, valores e envie mensagens oficiais prontas para o grupo do WhatsApp.
            </p>
          </div>
