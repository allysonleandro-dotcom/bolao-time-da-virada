...
export const VerificadorLotofacilView: React.FC<VerificadorViewProps> = ({
  ...
  const currentLotteryType: LotteryType = resolveLotteryType(activeBolao?.lotteryType, activeBolao?.title);
  ...
  const standardDrawnCount =
    lotteryConfig.standardBetCount || (currentLotteryType === 'mega-sena' ? 6 : currentLotteryType === 'dia-de-sorte' ? 7 : 15);
