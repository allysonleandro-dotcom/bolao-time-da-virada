...
export const CalculadoraView: React.FC<CalculadoraViewProps> = ({
  ...
  const handleLoadSpreadsheetPreset = (
    ...
    if (presetType === 'virada_57') {
      ...
      setGameMix([
        { id: '1', lotteryType: 'mega-sena', numbersCount: 11, quantity: 1 }, // 2.772,00 (1 aposta de 11 dezenas)
        { id: '2', lotteryType: 'mega-sena', numbersCount: 6, quantity: 14 },  // 14 x 6,00 = 84,00 (Total R$ 2.856,00)
      ]);
      setTargetQuotas(50); // 2.856,00 / 50 = R$ 57,12
      ...
      setSelectedLottery('mega-sena');
      setGameMix([
        { id: '1', lotteryType: 'mega-sena', numbersCount: 10, quantity: 1 }, // 1.260,00 (1 aposta de 10 dezenas)
        { id: '2', lotteryType: 'mega-sena', numbersCount: 6, quantity: 28 },  // 28 x 6,00 = 168,00 (Total R$ 1.428,00)
      ]);
      setTargetQuotas(40); // 1.428,00 / 40 = R$ 35,70
      setAdminFeePercent(0);
      setExtraCost(0);
      setExtraCostInput('0,00');
      setReserveFund(0);
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5 pt-1">
                ...
                >
                  <div>
                    ...
                    <div className="font-black text-xs text-white mt-0.5">
                      1x 11 Dezenas (462 jogos eq.)
                    </div>
                  </div>
                  <div className="mt-2">
                    <div className="text-sm font-black text-white group-hover:text-amber-200">
                      R$ 57,12 <span className="text-[10px] font-normal text-emerald-200">/ 50 cotas</span>
                    </div>
                ...
                >
                  <div>
                    ...
                    <div className="font-black text-xs text-white mt-0.5">
                      1x 10 Dezenas (210 jogos eq.)
                    </div>
                  </div>
                  <div className="mt-2">
                    <div className="text-sm font-black text-white group-hover:text-amber-200">
                      R$ 35,70 <span className="text-[10px] font-normal text-teal-200">/ 40 cotas</span>
                    </div>
              ...
              <div className="p-5 rounded-2xl border-2 border-emerald-500 bg-emerald-50/40 space-y-3 relative shadow-xs">
                ...
                <div>
                  ...
                  <div className="text-2xl font-black text-emerald-700 mt-1">
                    R$ 57,12 <span className="text-xs text-slate-500 font-medium">/ cota</span>
                  </div>
                </div>
                <div className="text-xs text-slate-600 space-y-1 font-medium pt-2 border-t border-emerald-200/70">
                  <div className="flex justify-between">
                    ...
                    <strong className="text-slate-900">R$ 2.856,00</strong>
                  </div>
                  <div className="flex justify-between text-[11px] text-slate-500">
                    <span>Aposta Principal (11 Dezenas):</span>
                    <span>R$ 2.772,00</span>
                  </div>
                  <div className="flex justify-between text-[11px] text-slate-500">
                    <span>Fundo / Jogos Adicionais:</span>
                    <span>R$ 84,00</span>
                  </div>
                </div>
                <button
              ...
              <div className="p-5 rounded-2xl border-2 border-teal-500 bg-teal-50/40 space-y-3 relative shadow-xs">
                ...
                <div>
                  ...
                  <div className="text-2xl font-black text-teal-700 mt-1">
                    R$ 35,70 <span className="text-xs text-slate-500 font-medium">/ cota</span>
                  </div>
                </div>
                <div className="text-xs text-slate-600 space-y-1 font-medium pt-2 border-t border-teal-200/70">
                  <div className="flex justify-between">
                    <span>Arrecadação Total:</span>
                    <strong className="text-slate-900">R$ 1.428,00</strong>
                  </div>
                  <div className="flex justify-between text-[11px] text-slate-500">
                    <span>Aposta Principal (10 Dezenas):</span>
